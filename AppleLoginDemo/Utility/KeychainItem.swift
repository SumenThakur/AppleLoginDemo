...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.WatchDemo.AppleLoginDemo", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.WatchDemo.AppleLoginDemo", account: "userIdentifier").deleteItem()
        } catch {
